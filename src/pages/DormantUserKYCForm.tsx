...
const DormantUserKYCForm: React.FC = () => {
    ...
    const handleDormantPasswordUpdated = useCallback(
        async (data: {
            ...
            const response = await authService.dormantPasswordUpdated(payload);
            ...
            <AuthLayout>
                ...
                {step === 'otp' && (
                    <OTPVerificationForm
                        ...
                        onPostVerificationAction={handleDormantPasswordUpdated}
                    />
                )}
            </AuthLayout>
